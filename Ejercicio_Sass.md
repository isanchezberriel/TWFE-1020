...
En la imagen se propone una estructura para una landing page de una empresa. El objetivo es especificar los estilos utilizando Sass. Se debe tener en cuenta las siguientes consideraciones:
